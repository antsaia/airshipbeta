          ...
          {releases.map((release) => (
            ...
            >
              ...
              <div className="relative p-8">
                ...
                <h3 className="text-xl font-semibold text-white group-hover:text-[#0052FF] transition-colors mb-3">
                  {release.title}
                </h3>
                <p className="text-gray-400 leading-relaxed mb-6">{release.description}</p>
                <span className="inline-flex items-center text-[#0052FF] font-medium group-hover:translate-x-2 transition-transform">
                  Learn more
