    ...
    <div className="relative overflow-hidden bg-gray-900 min-h-[80vh] flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative">
        <div className="text-center">
          <div className="inline-flex items-center bg-blue-900 bg-opacity-50 rounded-full px-4 py-2 mb-8">
            <Sparkles className="w-5 h-5 text-blue-400 mr-2" />
            <span className="text-blue-300 font-medium">Discover the Future</span>
          </div>
